...
class SystemClockIntegrationTest {
    ...
    private static final LocalDateTime INITIAL_DATETIME =
    ...
    void changesMariaBusinessDatetimeAndStoresAuditLog() throws SQLException {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            LocalDateTime beforeValue = LocalDateTime.parse(
                    resultSet.getString("before_value")
            );
            assertThat(beforeValue)
                    .isBetween(INITIAL_DATETIME, INITIAL_DATETIME.plusSeconds(2));
            assertThat(resultSet.getString("after_value"))
    ...
    void mariaBusinessDatetimeMovesForward() throws InterruptedException {
        ...
        assertThat(after).isBetween(
                before.plusSeconds(1),
                before.plusSeconds(2)
        );
    }

    private static void loadMapperXml(
