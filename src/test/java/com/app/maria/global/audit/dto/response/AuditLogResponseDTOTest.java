...
class AuditLogResponseDTOTest {
    ...
    void targetNameUsesTargetAdminNameForAdminUser() {
        AuditLogResponseDTO response =
                new AuditLogResponseDTO(auditLog("ADMIN_USER", "이국희", null, null));
    ...
    void targetNameUsesTargetAccountNoForSellOrder() {
        AuditLogResponseDTO response =
                new AuditLogResponseDTO(auditLog("SELL_ORDER", null, "1234567890", null));
    ...
    void targetNameUsesTargetOwnerAccountNoForAccount() {
        AuditLogResponseDTO response =
                new AuditLogResponseDTO(auditLog("ACCOUNT", null, null, "9000000001"));
    ...
    void targetNameFallsBackToTargetTableForSystemClock() {
        AuditLogResponseDTO response =
                new AuditLogResponseDTO(auditLog("SYSTEM_CLOCK", null, null, null));
    ...
    void targetNameFallsBackToActualTargetTableForUnknownType() {
        AuditLogResponseDTO response =
                new AuditLogResponseDTO(auditLog("SETTLEMENT_BATCH", null, null, null));

        assertThat(response.getTargetName()).isEqualTo("SETTLEMENT_BATCH");
    }
}
