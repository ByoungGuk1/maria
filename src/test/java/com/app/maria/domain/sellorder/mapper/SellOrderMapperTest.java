...
class SellOrderMapperTest {
    ...
    void selectSellOrdersByAccountIdReturnsAllOrdersForSameAccountWithoutDuplicates() throws SQLException {
        Long accountId = 300L;
    ...
    private SellOrderDTO newSellOrder(Long accountId, Long foreignProductId, Long inboundDetailId,
        ...
        return SellOrderDTO.builder()
                ...
                .status(status)
                .settlementFxRate(settlementFxRate == null ? null : new BigDecimal(settlementFxRate))
    ...
    private Long insertInboundDetail(Long inboundId) throws SQLException {
        String sql = "INSERT INTO inbound_detail (inbound_id, foreign_product_id, purchase_date, purchase_price, purchase_currency, purchase_fx_rate, qty, current_qty) "
