...
public class AccountLogServiceImpl implements AccountLogService {
  ...
  @Override
  public void recordStatusChange(AccountDTO account, Status previousStatus, LocalDateTime changedAt, String reason) {
  ...
  public String createLimitChangeReason(BigDecimal before, BigDecimal after) {
    return PREFIX + "from=" + before.stripTrailingZeros().toPlainString()
        + "|to=" + after.stripTrailingZeros().toPlainString();
  }

  @Override
  public void recordBenefitChange(AccountDTO account, BenefitType previousStatus, LocalDateTime changedAt, String reason) {
    AccountBenefitLogDTO log = AccountBenefitLogDTO.builder()
        .accountId(account.getAccountId())
        .prevStatus(previousStatus)
