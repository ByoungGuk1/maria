...
public class ExchangeRestTemplateConfig {
    ...
    public ExchangeRateClient settlementExchangeRateClient(
            @Qualifier("settlementRestTemplate") RestTemplate restTemplate,
            ExchangeApiProperties exchangeApiProperties,
